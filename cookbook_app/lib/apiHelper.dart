...
Future<String> searchApiForInfo(String recipeName) async {
  //final response = await http.read("https://api.spoonacular.com/recipes/findByNutrients?query=$recipeName&maxCalories=2000&number=1&apiKey=$spoonApi");
  //final response = await http.read("https://api.spoonacular.com/recipes/complexSearch?query=$recipeName&number=1&apiKey=$spoonApi&addRecipeNutrition=true");
